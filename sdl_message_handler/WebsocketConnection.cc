...
std::string WebsocketConnection::GetComponentName(std::string& method) {
...
bool WebsocketConnection::checkMessage(Json::Value& root, Json::Value& error) {
    Json::Value err;
...
bool WebsocketConnection::isNotification(Json::Value& root) {
    bool ret = false;
...
bool WebsocketConnection::isResponse(Json::Value& root) {
    bool ret = false;
