...
#ifndef _SDL_MESSAGE_HANDLER_VR_
#define _SDL_MESSAGE_HANDLER_VR_
...
class VR : public WebsocketConnection {
 public:
    VR(SDLMessageControllerImpl* controller);
...
#endif  // _SDL_MESSAGE_HANDLER_VR_
